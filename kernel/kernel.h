...
bool Kernel_SendMessage(KernelCircleQ_t QName, void* data, uint32_t count);
uint32_t Kernel_ReceiveMessage(KernelCircleQ_t QName, void* outData, uint32_t count);
