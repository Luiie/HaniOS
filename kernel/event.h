...
typedef enum KernelEventFlag_t
{
    ...
    KernelEventFlag_MtIn        = 0x00000004,
    KernelEventFlag_MtOut       = 0x00000008,
    KernelEventFlag_Unlock      = 0x00000010,
    KernelEventFlag_MessageIn  = 0x00000020,
    KernelEventFlag_MessageOut  = 0x00000040,
